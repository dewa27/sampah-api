            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="{{ route('sampah.index') }}" class="nav-link"><i class="fas fa-columns"></i>
                                <span>Master Jenis Sampah</span></a>
                        </li>
                        <li>
                            <a href="{{ route('sampah.index') }}" class="nav-link"><i class="fas fa-columns"></i>
                                <span>Master Driver</span></a>
                        </li>
                        <li>
                            <a href="{{ route('sampah.index') }}" class="nav-link"><i class="fas fa-columns"></i>
                                <span>Master Reward</span></a>
                        </li>
